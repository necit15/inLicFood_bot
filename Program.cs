...
namespace Telegram.Bot.Examples.Echo
{
    class Program
    {
        private static readonly TelegramBotClient Bot = new TelegramBotClient("224950515:AAH4qWQHA9Wfi-SEm0lNtSfJEI0trtaSNls");
        ...
        private static async void BotOnMessageReceived(object sender, MessageEventArgs messageEventArgs)
        {
            ...
            {
                Console.Write(DateTime.Now.ToLongTimeString());             // log information
                Console.WriteLine(" Send inline keyboard");                 // log information
                ...
                var keyboard = new InlineKeyboardMarkup(new[]
                {
                    new[] // first row
                    {
                        new InlineKeyboardButton("Hello world"),
            ...
            else if (message.Text.StartsWith("/command1")) // send custom keyboard
            {
                var usage = @"Usage:
hj4fj jfhkj hjhdhfjd 
bfejhfjhsjehfhsf
efsnnfjjeriu4iwri m
lji4oitu4utjeklnknkf
";
